...
public class Admin_AcademicTimetable extends javax.swing.JFrame {

    /**
     * Creates new form Admin_AcademicTimetable
     */
    public Admin_AcademicTimetable() {
        initComponents();
    ...
    private void DisplayImage(){
        ...
        try{
            ...
            if(rs.next()){
                ...
                jLabelAcademicTTimg.setIcon(icon1);
    ...
    private void initComponents() {
        ...
        jLabelAcademicTTimg = new javax.swing.JLabel();
        ...
        jLabelUsername.setText("Update Academic Timetable");
        ...
        jLabelAcademicTT.setFont(new java.awt.Font("Segoe UI", 1, 16)); // NOI18N
        ...
        jLabelAcademicTT.setOpaque(true);
        ...
        jLabelAcademicTTimg.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jScrollPane1.setViewportView(jLabelAcademicTTimg);
        ...
        if (output == JFileChooser.APPROVE_OPTION) {
            ...
            if(!imagePath.trim().isEmpty()){
                try{
                    ...
                    String sql= "update CS set academic_timetable=?;";
    ...
    private javax.swing.JLabel jLabelAcademicTTimg;
